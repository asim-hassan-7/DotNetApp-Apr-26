...

{
...

    {
        ...
        emp.SetEmployeeData(101,"Asim",77000);

        var std = new Student();
        std.SetStudentData(102, "Dayaan","Sgr");
        ...
        foreach (var item in al)
        {
            ...
            //Via Object  At Class 03-06-2026
            ...
            //via Genric At Class  03-06-2026
            ...
            //via Genric Class At Class 03-06-2026

            //bool comp1 = GenricM<int>.Compare(10, 20);
            //Console.WriteLine($"First Integer is equal to Second Integer: {comp1}");


            //bool comp2 = GenricM<string>.Compare("10", "10");
            //Console.WriteLine($"First String is equal to Second String: {comp2}");

            //bool genComp1 = GenricM<int>.GenericCompare(100, 100);
            //Console.WriteLine($"First Integer is equal to Second Integer: {genComp1}");


            //bool genComp2 = GenricM<string>.GenericCompare("noname", "name");
            //Console.WriteLine($"First String is equal to Second String: {genComp2}");
